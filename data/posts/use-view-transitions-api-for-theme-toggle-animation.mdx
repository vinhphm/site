...
date: 2024-06-27T19:22:11.543+07:00
lang: en
...
- <span class="icon-[simple-icons--mdnwebdocs]" /> MDN Web Docs · [View Transitions API](https://developer.mozilla.org/en-US/docs/Web/API/View_Transitions_API)
- <span class="icon-[logos--chrome]" /> Chrome for Developers · [Smooth transitions with the View Transition API](https://developer.chrome.com/docs/web-platform/view-transitions)
- <span class="icon-[devicon-plain--astro]" /> Astro Docs · [View transitions](https://docs.astro.build/en/guides/view-transitions/)
...
<Video client:idle src={themeTransitionAnimation} videoClass="rounded-xl w-2/3 md:w-1/2" />

This animation takes inspiration from [**@hooray**'s snippets](https://github.com/vuejs/vitepress/pull/2347) with some minor tweaks to avoid comflicting with Astro's **View Transitions** feature. You can find my implementation at [<span class="i-ph-file-vue" /> ThemeToggle.vue](https://github.com/vinhphm/site.archive/blob/archives/2024/src/components/ThemeToggle.vue), with some additional CSS rules as shown below:
