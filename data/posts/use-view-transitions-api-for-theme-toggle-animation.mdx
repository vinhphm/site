...
This animation takes inspiration from [**@hooray**'s snippets](https://github.com/vuejs/vitepress/pull/2347) with some minor tweaks to avoid comflicting with Astro's **View Transitions** feature. You can find my implementation at [<span class="i-ph-file-vue" /> ThemeToggle.vue](https://github.com/vinhphm/site/blob/archives/2024/src/components/ThemeToggle.vue), with some additional CSS rules as shown below:
