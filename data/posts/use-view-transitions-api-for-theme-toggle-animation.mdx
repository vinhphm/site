...
publishedAt: 2024-06-27T19:22:11.543+07:00
lang: en
...
import DeviconPlainAstro from '~icons/devicon-plain/astro'
...
- <DeviconPlainAstro /> Astro Docs · [View transitions](https://docs.astro.build/en/guides/view-transitions/)
...
This animation takes inspiration from [**@hooray**'s snippets](https://github.com/vuejs/vitepress/pull/2347) with some minor tweaks to avoid comflicting with Astro's **View Transitions** feature. You can find my implementation at [<PhFileVue /> ThemeToggle.vue](https://github.com/vinhphm/site.archive/blob/archives/2024/src/components/ThemeToggle.vue), with some additional CSS rules as shown below:
