...
createdDate: 2022-04-03T09:54:33.983+07:00
lang: en
...
<figure class="pt-5 flex flex-col items-center">
  <img src={menuToggle.src} alt="Menu toggle" class="shadow rounded-lg w-auto!" />
...
<figure class="pt-5 flex flex-col items-center">
  <img src={themeToggle.src} alt="Theme toggle" class="shadow rounded-lg w-auto!" />
  <figcaption class="text-center">
    Theme toggle
  </figcaption>
</figure>
