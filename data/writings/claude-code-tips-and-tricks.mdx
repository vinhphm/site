...
...or the Microsoft sees it, "COPILOT! COPILOT! COPILOT!"
...
- Take screenshots with <kbd>Shift ⇧</kbd> + <kbd>Command ⌘</kbd> + <kbd>Control ⌃</kbd> + <kbd>4</kbd> on macOS, then paste with <kbd>Control ⌃</kbd> + <kbd>V</kbd> (not <kbd>Command ⌘</kbd> + <kbd>V</kbd>!)
...
- **Stop Claude**: Use <kbd>Escape</kbd> (not <kbd>Control</kbd> + <kbd>C</kbd>, which exits entirely)
- **Jump to previous messages**: <kbd>Escape</kbd> twice to see all previous messages
