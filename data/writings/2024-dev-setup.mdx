...
added: 2024-01-26T20:23:11.823+07:00
lang: en
...
import subessenceVSCode from '@/assets/images/2024/subessence-vscode.png'
import terminal from '@/assets/images/2024/terminal.png'
...
<figure class="extended-py">
  <div class="extended-wrapper">
    <Image src={subessenceVSCode} alt="VS Code setup" class="shadow" />
  </div>
</figure>
...
<figure class="md:pt-3 lg:pt-6">
  <div class="extended-wrapper">
    <Image src={terminal} alt="iTerm with Starship prompt" />
  </div>
  <figcaption class="text-center">My terminal setup on macOS</figcaption>
</figure>
