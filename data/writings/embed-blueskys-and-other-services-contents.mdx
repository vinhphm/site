...
Everything started when I decided to be more active on [<BlueskyIcon /> Bluesky](https://bsky.app) and needed a way to integrate it more seamlessly with my website. I wanted to embed my posts directly into my blog posts, and have a share/comment button that would open the post on Bluesky.
