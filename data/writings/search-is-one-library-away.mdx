---
title: Search is one library away
pubDate: 2025-01-16T10:30:00.000+07:00
...
```astro title="src › components › Header.astro" showLineNumbers {5-6,52,57} collapse={1-3,8-50,59-95}
---
...
const socialLinks = structuredClone(siteConfig.socialLinks).filter(
...
<header class="header relative z-40">
  <a
    class="absolute m-7 select-none outline-none lg:fixed"
    href="/"
    aria-label="Logo"
  >
  ...
  <nav class="nav">
    ...
    <div class="right tracking-tight print:op0 items-center">
      ...
      <a
        target="_blank"
        href="/rss.xml"
        class="lt-md:hidden i-ri-rss-line nav-link"
        aria-label="RSS"></a>
