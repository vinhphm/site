...
In a previous post, we discussed how to [generate refresh tokens for Spotify API calls](/writing/staying-authenticated-with-spotify). Now, let's dive into the exciting part: using Cloudflare Workers to interact with the Spotify API.. Now, let's dive into the exciting part: using Cloudflare Workers to interact with the Spotify API.

## A Worker API to handle Spotify APIs call

Before we begin, make sure you have a basic understanding of Cloudflare Workers and have set up a blank Worker with a configured route.
...
<figure ckass="pt-5">
  ...
  />
  <figcaption class="text-center">Spotify current playing</figcaption>
</figure>
